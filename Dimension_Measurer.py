...
# dilated_edges=cv2.imread(r"C:\Users\User\Documents\GitHub\Cathay-Cargo\a_closed_box_on_conveyor_belt_from_the_top_view.png",0)
# img = cv2.bitwise_not(dilated_edges)
...
#on the line between p1 and p2, at 1/3 distance from p2
def get_intermediate_point(p1,p2,ratio):
    return [p1[0]+int((p2[0]-p1[0])/ratio), p1[1]+int((p2[1]-p1[1])/ratio)]
